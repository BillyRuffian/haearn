...
ActiveRecord::Schema[8.1].define(version: 2026_09_23_080000) do
  ...
  create_table "template_blocks", force: :cascade do |t|
    ...
    t.index ["workout_template_id", "removed_at"], name: "index_template_blocks_on_workout_template_id_and_removed_at"
  ...
  create_table "workouts", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_workouts_on_one_active_per_user", unique: true, where: "finished_at IS NULL"
